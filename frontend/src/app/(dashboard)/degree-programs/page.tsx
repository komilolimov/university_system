...
export default function DegreeProgramsPage() {
  ...
  const canWrite = hasPermission("degree_programs:write");
  const canDelete = hasPermission("degree_programs:delete");
  ...
  return (
    <main className="flex-1 flex flex-col h-full p-6 lg:p-8">
      ...
      <div className="flex-1 min-h-[600px] w-full">
        <DegreeProgramsDataGrid canWrite={canWrite} canDelete={canDelete} />
      </div>
    </main>
  );
}