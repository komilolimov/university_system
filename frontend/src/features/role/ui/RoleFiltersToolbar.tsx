...
interface RoleFiltersToolbarProps {
  ...
  selectedType: "all" | "faculty" | "non-faculty";
  onTypeChange: (value: "all" | "faculty" | "non-faculty") => void;
  selectedStatus: "all" | "active" | "inactive";
  onStatusChange: (status: "all" | "active" | "inactive") => void;
}

export const RoleFiltersToolbar = ({
  searchQuery,
  onSearchChange,
  selectedType,
  onTypeChange,
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center gap-3 w-full bg-white p-3 rounded-lg border border-neutral-200 shadow-sm select-none">
      ...
      <div className="w-full md:w-48">
        <select
          value={selectedType}
          onChange={(e) => onTypeChange(e.target.value as "all" | "faculty" | "non-faculty")}
        ...
        >
          ...
          <option value="non-faculty">Non-Faculty Only</option>
        </select>
      </div>
